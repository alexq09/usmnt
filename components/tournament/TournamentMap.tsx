        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            {tournamentPath.map((location, idx) => {
              const nextLocation = idx < tournamentPath.length - 1 ? tournamentPath[idx + 1] : null;
              return (
                <div key={location.id}>
                  <div className="flex items-start gap-4 p-4 rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800">
                  ...
                  {nextLocation && (
                    <div className="flex items-center gap-3 py-2 px-4 ml-8">
                      <div className="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-300 bg-blue-50 dark:bg-blue-900/30 px-3 py-2 rounded-md border border-blue-200 dark:border-blue-800">
